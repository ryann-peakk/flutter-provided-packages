...
class CameraApi {
  ...
  Future<int?> getShutterSpeed() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_android.CameraApi.getShutterSpeed$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<void> setShutterSpeed(int shutterSpeedNs) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_android.CameraApi.setShutterSpeed$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[shutterSpeedNs])
            as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<List<int>> getShutterSpeedRange() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_android.CameraApi.getShutterSpeedRange$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
